...
- ae1ed52: 상태색 팔레트 단계 신설 — `--color-danger-*` · `--color-success-*` · `--color-warning-*`
...
- 7435023: Lighten gray-50 (#f9fafb → #fafbfc) and gray-100 (#f3f4f6 → #f5f6f8). gray-100 backs the `--default` surface and was nudged lighter toward the reference value; gray-50 (`--surface-secondary`) moves with it to keep the 50↔100 lightness step, and both hues now align with the rest of the gray scale (264.5deg).

## 3.0.0

### Major Changes

- 29b213c: Rename the package from `@demodev-ui/react` to `@jocoding-ax-partners/design-system`.
